# Hello! My name is Felipe Borges

**`FullStack Developer`** **`Web Developer`** **`PHP Developer`**

I'm a Software Developer focused on web application development. I'm currently pursuing a degree in Systems Analysis and Development at IFSC. I work mainly with Laravel, Livewire, PHP, and I also have experience with JavaScript and Java. I'm passionate about technology, software development, and continuous learning, always looking for opportunities to improve my skills and build efficient, scalable, and high-quality solutions.
...
![Flux](https://img.shields.io/badge/Flux-FF2D20?style=flat-square&logo=laravel&logoColor=white)
